...
4. ✅ `GET /api/events` - 事件列表 (新接入)
5. ✅ `POST /api/events` - 创建事件 (新接入)
6. ✅ `GET /api/events/{id}` - 获取事件详情 (新接入)
7. ✅ `PUT /api/events/{id}` - 更新事件 (新接入)
8. ✅ `PUT /api/events/{id}/display` - 更新事件显示状态 (新接入)
